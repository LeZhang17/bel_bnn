...
hidden_units = 110  # number of hidden units in the dense layer
num_components = 42  # number of components in the mixture
...
# Compile the model
model.compile(optimizer=tf.optimizers.Adam(learning_rate=0.006), loss=nll)
...
# CRPS: 1.3625149018234526
# RMSE: 2.6092121545532114, RMSPE: 0.10100857094033336