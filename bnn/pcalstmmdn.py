...
model = Sequential([
    LSTM(100, activation='tanh', input_shape=(X_train_pca.shape[1], 1), return_sequences=False),
...
# CRPS: 0.6590790333579574
# RMSE: 1.4384773600591176, RMSPE: 0.06173998419409343